...
function HiddenTerminal({
  ...
  useFrame((state) => {
    ...
    const screen = g.children[0];
    if (screen) screen.rotation.y = Math.sin(state.clock.elapsedTime * 0.6) * 0.15;
  });
      ...
      <group>
        ...
        >
          ...
          <meshStandardMaterial
            color="#05070f"
            emissive={found ? '#34d399' : near ? '#facc15' : '#1c2438'}
            emissiveIntensity={found ? 0.9 : near ? 1.2 : 0.35}
          />
        </mesh>
      </group>
      {near && (
